...
export class OrderModel {
  ...
  public async insert(order: OrderDto): Promise<number> {
    const sqlString: SQLStatement = sql`INSERT INTO buygo.order (m_id, Address, Status, deliveryMethodId, transactionTypeId) VALUES (${order.memberId}, ${order.address}, 1 , ${order.deliveryId}, ${order.transactionId});`;
